...
<div class="term-grid" markdown>
  <article><h3>Seam</h3><p>A stitching line formed by joining two pieces of fabric.</p></article>
  <article><h3>Seam line</h3><p>The line that indicates where the seam should be stitched.</p></article>
  <article><h3>Seam allowance</h3><p>Extra fabric between the raw edge and stitching line to protect the seam from fraying.</p></article>
  <article><h3>Seam finish</h3><p>A treatment applied to raw seam edges, such as overlocking, edge stitching, pinking or turning and stitching.</p></article>
  <article><h3>Fray</h3><p>Threads that come out from the raw fabric edge during handling.</p></article>
  <article><h3>Basting / Tacking</h3><p>Temporary long stitches or pins used to hold fabric before final stitching.</p></article>
</div>
...
<div class="checklist-panel" markdown>
  <p><strong>Before cutting fabric, ask:</strong></p>
  <ul>
