...
<div class="comparison-cards" markdown>
  <section>
    <h3>Plain weave</h3>
    <p>The simplest weave, with warp and weft interlacing alternately. It has maximum interlacement, giving firmness and stability.</p>
    <p><strong>Examples:</strong> cambric, muslin, canvas, shirting, suiting, sarees and dhothi fabrics.</p>
  </section>
  <section>
    <h3>Twill weave</h3>
    <p>Recognised by diagonal line formation. It has fewer interlacements than plain weave, often giving better drape and greater weight.</p>
    <p><strong>Examples:</strong> denim, drill cloth, khaki uniforms, blankets, shirtings and furnishings.</p>
  </section>
  <section>
    <h3>Satin / Sateen weave</h3>
    <p>Uses floating yarns to create a smooth lustrous surface. The fabric may be warp-faced or weft-faced.</p>
    <p><strong>Examples:</strong> ribbons, trimmings, dresses and linings.</p>
  </section>
</div>
